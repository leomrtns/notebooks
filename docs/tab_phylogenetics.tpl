...
$( document ).ready(function(){
            ...
            var file=tab_phylogeneticsDict[$("h1:first").attr("id")];
            $("#toc-level0 a").css("color","#126dce");
            $('a[href="#'+$("h1:first").attr("id")+'"]').hide()
            var docs=tab_phylogeneticsArray;
            var docs_map=tab_phylogeneticsArrayMap;
            var pos=tab_phylogeneticsArray.indexOf(file);
            for (var a=pos;a>=0;a--){
